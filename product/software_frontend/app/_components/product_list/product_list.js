...
const ProductList = async ({ categories_list, page_number }) => {
  ...
  let categories_param = categories_list.length === 1 && categories_list[0] === "home" ? "" : categories_list.join(",");
  console.log("##### ------->", categories_list , page_number , previousPage , nextPage );
    ...
    <div className={styles.productListMain}>
      ...
      <div className={styles.pageChange}>
        ...
        <div className={styles.next}>
          <Link href={`/${categories_list}/${nextPage}`}>
            Next &gt;
          </Link>
        </div>
      </div>
