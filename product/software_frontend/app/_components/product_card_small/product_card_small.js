...
const ProductCardSmall = ({product_data}) => {
  ...
  const product_redirect_url = product_data["product_featured"] ? product_data["product_url"]: product_page_url
  return (
        ...
        <div className={styles["productItems"]}>
          <div className={styles["productCategories"]}>
            <div className={styles["productCategory"]}>
              <Link href={categories_url}>{product_data["product_categories"][0]}</Link>
              </div>
          </div>
